...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.create') }} {{ trans('cruds.newsroom.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route('admin.newsrooms.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('article_sentence') ? 'is-invalid' : '' }}" type="text"
                        name="article_sentence" id="article_sentence" value="{{ old('article_sentence', '') }}">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('seo_keywords') ? 'is-invalid' : '' }}"
                        name="seo_keywords" id="seo_keywords">{!! old('seo_keywords') !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('photo_caption') ? 'is-invalid' : '' }}" type="text"
                        name="photo_caption" id="photo_caption" value="{{ old('photo_caption', '') }}">
