...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.contacts.update", [$contact->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="telephone_number">{{ trans('cruds.contact.fields.telephone_number') }}</label>
                <input class="form-control {{ $errors->has('telephone_number') ? 'is-invalid' : '' }}" type="text" name="telephone_number" id="telephone_number" value="{{ old('telephone_number', $contact->telephone_number) }}">
                @if($errors->has('telephone_number'))
                    <div class="invalid-feedback">
                        {{ $errors->first('telephone_number') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.contact.fields.telephone_number_helper') }}</span>
            </div>
            <div class="form-group">
