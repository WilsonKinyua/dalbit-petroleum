    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.divisions.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('division_type') ? 'is-invalid' : '' }}" name="division_type_id" id="division_type_id" required>
                    @foreach($division_types as $id => $entry)
                        <option value="{{ $id }}" {{ old('division_type_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('country_description') ? 'is-invalid' : '' }}" name="country_description" id="country_description">{!! old('country_description') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('operation_description') ? 'is-invalid' : '' }}" name="operation_description" id="operation_description">{!! old('operation_description') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('transport_description') ? 'is-invalid' : '' }}" name="transport_description" id="transport_description">{!! old('transport_description') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('infrastructure_storage_description') ? 'is-invalid' : '' }}" name="infrastructure_storage_description" id="infrastructure_storage_description">{!! old('infrastructure_storage_description') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('contacts') ? 'is-invalid' : '' }}" name="contacts_id" id="contacts_id">
                    @foreach($contacts as $id => $entry)
                        <option value="{{ $id }}" {{ old('contacts_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
